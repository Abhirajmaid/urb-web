...
export const websiteSchema = {
  ...
  url: "https://urbinsurance.com",
  description:
    "Leading insurance company providing comprehensive insurance solutions for individuals and businesses.",
  potentialAction: {
    "@type": "SearchAction",
    target: {
      "@type": "EntryPoint",
      urlTemplate: "https://urbinsurance.com/search?q={search_term_string}",
    },
