...
export function HeroSection() {
  ...
  return (
    <section className="bg-[#3b1d1c] lg:bg-[#f4f0ee] px-4 sm:px-6 lg:px-20 lg:pt-[90px] pt-0 pb-0 min-h-screen flex items-start -mt-[56px]">
      <div className="w-full">
        {/* Mobile: Light beige card, Desktop: White card */}
        <div className="w-full rounded-2xl border border-[#e9e0dd] bg-[#f4f0ee] lg:bg-white shadow-[0_10px_30px_-15px_rgba(0,0,0,0.25)] min-h-[95vh] lg:min-h-0">
            ...
            <div className="flex flex-col justify-between h-full min-h-[calc(85vh-3rem)] sm:min-h-[calc(85vh-4rem)] lg:grid lg:grid-cols-2 lg:items-center lg:gap-8 lg:min-h-0 lg:h-auto">
              ...
              <div className="relative flex-1 min-h-[320px] sm:min-h-[380px] lg:h-[500px] order-2 lg:flex-none">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(59, 29, 28, 0) 0%, rgba(59, 29, 28, 0.3) 30%, rgba(59, 29, 28, 0.6) 60%, rgba(59, 29, 28, 0.9) 100%)",
                  }}
                />
